...
{   
  ...
  dato = Lectura_teclado();
	...
	if(dato == 0xE0)	// BOTON A
	{
		valor = 10;
	}
	else if(dato == 0xD0)//BOTOB B
	{
		valor = 11;
	}
	else if(dato == 0xB0)			// BOTON C	//BOTON SALIR CAMBIAR NUMERO
	{
		valor = 12;
	}
	else if(dato == 0x70)		//BOTON D		//BOTON ENTRAR CAMBIAR NUMERO
	{
		valor = 13;
	}
