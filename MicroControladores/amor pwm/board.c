...
//para llamar un funcion dentro de otra funcion se deben declarar arriba
...
{	
  ...
  GPIO_PORTE_DIR_R 			= 0xF0;          			// 5)    
  GPIO_PORTE_AFSEL_R 		= 0x0F;        				// 6) 
  GPIO_PORTE_PUR_R 			= 0x00;          			//            
  GPIO_PORTE_DEN_R 			= 0xF0;          			// 7) 
}
...
//_____________________AQWESRDCF___________________--
...
int Lectura(void)
{
	return GPIO_PORTF_DATA_R; // devueleve el VALOR del gpioF (botones)  y SE DEVUELVE AL MAIN.c
}
