...
int teclado_4x4(void)
{
	...
	{
		Nokia5110_SetCursor(0,5);
		sprintf(buffer1,"int=%6d", unidades);
		Nokia5110_OutString(buffer1);
	...
	while(1)
	{
		...
		Nokia5110_SetCursor(0,5);
		sprintf(buffer1,"int=%6d", unidades*10+decenas);
		Nokia5110_OutString(buffer1);
  ...
  while(1)
	{
		Nokia5110_SetCursor(0,5);
		sprintf(buffer1,"int=%6d", unidades*100+decenas*10+centenas);
		Nokia5110_OutString(buffer1);
	...
	{
		Nokia5110_SetCursor(0,5);
		sprintf(buffer1,"int=%6d", unidades*1000+decenas*100+centenas*10+umil);
		Nokia5110_OutString(buffer1);
	...
	{
		Nokia5110_SetCursor(0,5);
		sprintf(buffer1,"int=%6d", unidades*10000+decenas*1000+centenas*100+umil*10+dmil);
		Nokia5110_OutString(buffer1);
	...
	//-----------------------------------------------------------------------
	total=unidades*100000;
	total+=decenas*10000+centenas*1000+umil*100+dmil*10+cmil;
