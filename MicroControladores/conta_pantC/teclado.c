...
int valor()
{
  ...
  num_decimal = Lenc();
	...
	if(num_decimal == 0x80)			// BOTON C	//BOTON SALIR CAMBIAR NUMERO
	{
		salida = 12;
	}
	else if(num_decimal == 0x40)		//BOTON D		//BOTON ENTRAR CAMBIAR NUMERO
	{
		salida = 13;
	}
//	else if(num_decimal == 0xC0)	// SALIR DE CAMBIAR NUMERO
//	{
//		salida = 10;
//	}
//	else if(num_decimal == 0x80)
//	{
//		salida = 11;
//	}
