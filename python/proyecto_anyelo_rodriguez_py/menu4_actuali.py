...
def menu4_():
    ...
    label_cedula=Label(mi_frame,text="Cedula del usuario: ",font=25,bg="white")
    label_cedula.grid(row=0,column=0,pady="15",padx="15",columnspan=2,sticky="e")

    entry_cedula=Entry(mi_frame,cursor="hand2",bd=3,relief="groove",textvariable=cedula)
    entry_cedula.grid(row=0,column=3,pady="5",ipadx=20,columnspan=2,sticky="w")

    label_actualizar=Label(mi_frame,text="ACTULICE DATOS ",font=("Times",20),bg="white")
    label_actualizar.grid(row=1,column=0,pady="0",padx="5",columnspan=6)

    label_nombre=Label(mi_frame,text="Nombre: ",font=25,bg="white")
    label_nombre.grid(row=2,column=0,pady="10",padx="5",sticky="w")

    entry_nombre=Entry(mi_frame,cursor="hand2",bd=3,relief="groove",textvariable=nombre)
    entry_nombre.grid(row=2,column=1,pady="10",ipadx=40)

    
    label_apellido=Label(mi_frame,text="Apellido: ",font=25,bg="white")
    label_apellido.grid(row=3,column=0,pady="10",padx="5",sticky="w")

    entry_apellido=Entry(mi_frame,cursor="hand2",bd=3,relief="groove",textvariable=apellido)
    entry_apellido.grid(row=3,column=1,pady="10",ipadx=40)
    
    label_edad=Label(mi_frame,text="Edad: ",font=25,bg="white")
    label_edad.grid(row=4,column=0,pady="10",padx="5",sticky="w")

    entry_edad=Entry(mi_frame,cursor="hand2",bd=3,relief="groove",textvariable=edad)
    entry_edad.grid(row=4,column=1,pady="10",ipadx=40)

    label_telefono=Label(mi_frame,text="telefono: ",font=25,bg="white")
    label_telefono.grid(row=2,column=4,pady="10",padx="5",sticky="w")

    entry_telefono=Entry(mi_frame,cursor="hand2",bd=3,relief="groove",textvariable=telefono)
    entry_telefono.grid(row=2,column=5,pady="10",ipadx=40)

    label_direccion=Label(mi_frame,text="direccion: ",font=25,bg="white")
    label_direccion.grid(row=3,column=4,pady="10",padx="5",sticky="w")

    entry_direccion=Entry(mi_frame,cursor="hand2",bd=3,relief="groove",textvariable=direccion)
    entry_direccion.grid(row=3,column=5,pady="10",ipadx=40)

    label_temperatura=Label(mi_frame,text="Temperatura: ",font=25,bg="white")
    label_temperatura.grid(row=4,column=4,pady="10",padx="5",sticky="w")

    entry_temperatura=Entry(mi_frame,cursor="hand2",bd=3,relief="groove",textvariable=Temperatura)
    entry_temperatura.grid(row=4,column=5,pady="10",ipadx=40,sticky="w")

    label_comentarios= Label(mi_frame,text="Observaciones generales: ",font=25,bg="white")
    label_comentarios.grid(row=7,column=0,pady=0,padx=5,sticky="w",columnspan=3)

    text_comentarios = Text(mi_frame,width="80",height="6",bd=3,relief="groove")
    text_comentarios.grid(row=8,column=0,columnspan=6,pady="10")

    #barra de desplazamiento
    mi_scroll_y=Scrollbar(mi_frame, command=text_comentarios.yview)
    mi_scroll_y.grid(row=8,column=6,sticky="nsew")
    ...
    label_genero.grid(row=5,column=4,sticky="w",rowspan=2)
    ...
    radio_boton_masculino.grid(row=5,pady =0,column=5,sticky="w")
    ...
    radio_boton_femenino.grid(row=6,column=5,pady =0,sticky="w")
    ...
    def buscar():
        ...
        nombre.set(lista[0][2])
        apellido.set(lista[0][3])
        edad.set(lista[0][4])
        if lista[0][5]=="m":
            opciones_genero.set(1)
        elif lista[0][5]=="f":
            opciones_genero.set(2)
        telefono.set(lista[0][7])
        direccion.set(lista[0][8])
        Temperatura.set(lista[0][9])
        conexion.close()
    ...
    def actualizar():
        ...
        conexion.commit()
        conexion.close()
        messagebox.showinfo("informacion","se actualizo la informacion del cliente correctamente")
    ...
    boton_buscar=Button(mi_frame,text="Buscar",command=buscar,font=25)
    boton_buscar.grid(row=0,column=5,padx="20",pady="0",columnspan=1,sticky="w")

    boton_actualizar=Button(mi_frame,text="Actualizar",command=actualizar,font=25)
    boton_actualizar.grid(row=9,column=0,padx="20",pady="5",columnspan=6)
